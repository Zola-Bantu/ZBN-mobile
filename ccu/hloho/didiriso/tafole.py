...
class Tafole(SeemoKN):
	...
	def lata_basebedisi(nna):
		...
		for mosebedisi in basebedisi:
			...
			neng = str(mosebedisi['last_login'])
			if len(neng) > 10:
				neng = neng[:10]
			fneng.append(neng)
	...
	def manollo(nna):
		...
		'''
		tpv = lata_pv()
		for mosebedisi in tpv:
			metshireletsi1.append(str(mosebedisi['user']))
			dinaha.append(mosebedisi['naha'])
			neng = str(mosebedisi['timestamp'])
			if len(neng) > 10:
				neng = neng[:10]
			fneng1.append(neng)
			#if mosebedisi['is_superuser'] == True:
		...
		ffneng1 = {}
		#while idx < botelele:
		#	mmetshireletsi1[idx + 1] = metshireletsi1[idx]
		#	ddinaha[idx + 1] = dinaha[idx]
		#	dditoropo[idx + 1] = ditoropo[idx]
		#	#dditulo1[idx + 1] = ditulo1[idx]
		#	ffneng1[idx + 1] = fneng1[idx]
		#	
		#	idx +=1
		#	
		bbasebedisi1.append(("mosebedisi" ,mmetshireletsi1))
		bbasebedisi1.append(("naha" ,ddinaha))
		bbasebedisi1.append(("toropo", dditoropo))
		#bbasebedisi1.append(("ditulo", dditulo1))
		bbasebedisi1.append(("fneng", ffneng1))
		print(bbasebedisi)
		#return bbasebedisi1
